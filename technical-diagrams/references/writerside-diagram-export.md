...
6. Build every affected Writerside instance with `wrs build <instance>`, or every instance with `wrs build`, when the builder is available.
7. Serve the output with `wrs serve` and open the rendered topic.
