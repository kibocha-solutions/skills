...
## Phase 2: Domain Skill Rule Routing & Checklists
- [x] Route proposal, operative text, and citation rules into `documentation/`
- [x] Route tier floor and clause command discipline into `legalese/`
- [x] Route correspondence tone and external boundary into `communications/`
- [x] Route layout, freshness, and exact-artifact hash rules into format skills (`pdf`, `docx`, `pptx`, `xlsx`)
